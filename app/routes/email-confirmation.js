...
module.exports = [{
  ...
  handler: async (_request, h) => {
    _request.payload = { frn: '1234567890' } // frn comes from here from redirect once auth is required -- initially once click on link, i.e. system/<frn>/statements/1 if not authorised, redirect here with frn as payload, however if auth is killed mid-session then frn payload will be null, therefore redirect out and force to use link again or resend or something
